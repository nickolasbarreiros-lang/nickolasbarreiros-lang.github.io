import { orquideas } from "./dados/orquideas/index-refinado-v5.js";


// Marcador público de compilação para auditoria no console do navegador.
window.__ORQUIDARIO_BUILD__ = "20260806-1815-refino-v5-cache-bypass";
console.info("[Orquidário] build carregado:", window.__ORQUIDARIO_BUILD__);
...
window.__ORQUIDARIO_DATA_AUDIT__ = {
    build: "20260806-1815-refino-v5-cache-bypass",
    id: idOrquidea,
    encontrado: Boolean(orquidea),
    descricaoLength: orquidea?.descricao?.length || 0,
    descricaoInicio: orquidea?.descricao?.slice(0, 90) || ""
};
console.info("[Orquidário] auditoria de dados:", window.__ORQUIDARIO_DATA_AUDIT__);
