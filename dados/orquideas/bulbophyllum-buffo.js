...
export const bulbophyllumBuffo = {
    ...
    descricao: "Uma orquídea africana de aparência realmente incomum! Bulbophyllum falcatum var. bufo chama atenção não pelo tamanho de cada flor, mas pela inflorescência: uma haste pode chegar a cerca de 30 cm e termina em uma raque larga, achatada e alongada, com numerosas pequenas flores distribuídas ao longo das laterais. A coloração é bastante variável, combinando creme ou amarelo-pálido com manchas carmesim, avermelhadas ou púrpuras.\n\nÉ uma planta principalmente de terras baixas da África tropical, registrada aproximadamente do nível do mar a 500 m, o que combina muito bem com condições quentes. O antigo nome Bulbophyllum bufo ainda aparece com frequência em coleções e literatura de cultivo, mas hoje é tratado como sinônimo desta variedade.",
    ...
    adaptacaoRegional: {
        litoralQuente: { texto: "Origem principalmente entre 0 e 500 m; ventilação e drenagem são os fatores críticos." },
        montanhaFrio: { texto: "Boa se protegida de frio prolongado; não requer resfriamento para florescer." }
    },
