...
export const catasetumMattosianum = {
    ...
    suporte: "🥇 Vaso plástico bem perfurado, capaz de conservar a umidade necessária durante o verão.\n🥈 Cachepô ou cesto de madeira para manejo com regas frequentes.\n🥉 Cesta plástica ou vaso tipo cuia, combinando ventilação e retenção moderada.",
    substrato: "🥇 Esfagno de fibra longa solto + pedra-pomes + carvão vegetal.\n🥈 Casca de pinus média + esfagno picado + pedra-pomes.\n🥉 Pedra-pomes + argila expandida + pequena quantidade de esfagno, em sistema aberto.\nO objetivo é reter bastante água na fase ativa sem perder oxigenação.",
    ...
    dica: "🏆 Replante cedo e mude completamente o manejo quando as novas raízes estiverem prontas. Faça o replante no início da brotação, antes que as raízes alonguem. Depois, mantenha o vaso relativamente seco até que várias raízes tenham cerca de 5 a 8 cm; então passe para muita água, adubação leve e frequente, luz alta e ventilação. Com a queda das folhas, suspenda a adubação e deixe o vaso predominantemente seco. Preserve pseudobulbos antigos saudáveis: eles alimentam a próxima brotação.",
    adaptacaoRegional: {
        litoralQuente: "Excelente. O calor favorece o crescimento ativo; o principal cuidado é proteger a planta desfolhada de chuvas repetidas durante a dormência.",
