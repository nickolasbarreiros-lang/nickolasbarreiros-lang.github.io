...
export const cattleyaLoddigesii = {
    ...
    substrato: "🥇 Casca de pinus média/grossa + carvão vegetal + pedra-pomes.\n🥈 Casca grossa + carvão + brita ou pedra-pomes para máxima drenagem.\n🥉 Casca média + carvão + argila expandida para maior estabilidade hídrica.\nMantenha o rizoma sempre sobre a superfície, nunca enterrado, e substitua substrato degradado antes que perca a aeração.",
    ...
    adaptacaoRegional: {
        litoralQuente: "Adapta-se muito bem à Serra/ES. Mantenha luminosidade alta filtrada, substrato aberto e ventilação constante. No verão, uma planta em vaso muito aerado pode exigir bastante água; no inverno, ajuste a frequência pela secagem real, não apenas pelo calendário.",
