...
export const bulbophyllumRoxburghii = {
    ...
    descricao: "Pequena no porte, mas muito charmosa quando floresce! *Bulbophyllum roxburghii* cresce horizontalmente sobre um rizoma rastejante, formando pseudobulbos arredondados e folhas firmes. Suas hastes terminam em pequenas umbelas com várias flores claras marcadas por vermelho a púrpura, criando um conjunto delicado acima da folhagem. É nativa da região do Himalaia Oriental, alcançando Assam e Bangladesh, e ocorre também em áreas relativamente baixas e quentes — portanto, o nome associado às montanhas não deve levar à ideia de uma orquídea obrigatoriamente fria. O epíteto *roxburghii* homenageia o botânico William Roxburgh.",
