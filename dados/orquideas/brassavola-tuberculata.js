...
export const brassavolaTuberculata = {
    ...
    descricao: "Uma das Brassavola mais interessantes para quem gosta de flores perfumadas! Suas folhas são longas, estreitas, cilíndricas e carnosas, enquanto as flores têm formato estrelado, com sépalas e pétalas finas envolvendo um vistoso labelo branco. O perfume, frequentemente lembrando gardênia, fica muito mais evidente durante a noite. Nativa de uma ampla faixa da América do Sul, ocorre tanto como epífita quanto sobre rochas e ocupa ambientes que vão de regiões quentes e sazonalmente secas a áreas mais elevadas. Essa diversidade ajuda a explicar sua boa adaptação, desde que receba bastante luz, ventilação e raízes que sequem rapidamente após as regas.",
    origem: "América do Sul",
    regiao: "Bolívia · Paraguai · Brasil · NE Argentina",
    habitat: "Epífita/litófita · ambientes sazonais · ampla altitude",
    clima: "Quente–intermediário · muito luminoso · ventilado",
    ...
    floracao: "Principalmente do fim da primavera ao início do verão, com variação entre populações e cultivo. Touceiras vigorosas podem apresentar florações fora da janela principal.",
    ...
    adaptacaoRegional: {
        litoralQuente: { texto: "Excelente Uma das espécies mais adequadas ao litoral quente, desde que as raízes permaneçam muito aeradas." },
        montanhaFrio: { texto: "Tolera noites frescas; apenas proteja de geadas e reduza água quando a secagem ficar lenta." }
    },
