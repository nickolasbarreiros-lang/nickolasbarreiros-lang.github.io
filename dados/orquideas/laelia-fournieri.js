...
export const laeliaFournieri = {
    ...
    substrato: "🥇 Pedra-pomes + brita pequena/média + caco de telha.\n🥈 Pedra vulcânica + pedra-pomes + brita.\n🥉 Pedra-pomes + brita + pequena proporção de casca de pinus grossa e firme.\nO meio pode ser predominantemente mineral, mas não precisa ser 100% inerte. O objetivo é oxigenação, drenagem rápida e controle do aquecimento.",
