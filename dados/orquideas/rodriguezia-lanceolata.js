...
export const rodrigueziaLanceolata = {
    ...
    "substrato": "🥇 Casca de pinus fina a média + carvão miúdo + pedra-pomes + porção mínima de esfagno.\n🥈 Em montagens: apenas fina camada de esfagno junto às raízes para adaptação inicial.\nA mistura deve hidratar as raízes, mas voltar a respirar rapidamente.",
