...
export const cattleyaLueddemannianaTipo = {
    ...
    rega: "Durante o crescimento ativo, regue abundantemente e deixe o sistema radicular secar de forma significativa antes da próxima irrigação. Após a maturação do pseudobulbo, aumente gradualmente o intervalo entre as regas, mantendo a planta mais seca sem provocar desidratação excessiva. Em Serra/ES, a frequência deve acompanhar o suporte, a temperatura e a velocidade real de secagem.",
    ...
    substrato: "🥇 Casca de pinus grossa + carvão vegetal + pedra-pomes.\n🥈 Carvão + casca grossa + brita ou pedra-pomes.\n🥉 Casca grossa + argila expandida + carvão vegetal.\nO centro do recipiente precisa permanecer oxigenado; substrato velho e decomposto deve ser substituído antes de perder a drenagem.",
    ...
    adaptacaoRegional: {
        litoralQuente: "Adapta-se muito bem à Serra/ES. O calor é compatível com sua origem; o maior risco é a combinação de noites quentes, substrato fechado e raízes permanentemente molhadas. Prefira boa ventilação, vaso ou cachepô arejado e luz filtrada forte.",
