...
export const maxillariaLeucaimata = {
    ...
    "substrato": "Opção 1: Casca de pinus média + carvão vegetal + pedra-pomes ou brita fina.\n\nOpção 2: Casca de pinus média + carvão vegetal + pedra-pomes + 10% a 20% de esfagno picado e solto para ambientes mais secos.\n\nOpção 3: Casca de pinus média + carvão vegetal + pequena fração de akadama ou brita fina para aumentar a estabilidade da umidade sem perder a drenagem.\n\nMantenha sempre o rizoma sobre a superfície do substrato. Replante quando a mistura perder estrutura, permanecer molhada por tempo excessivo ou no início da emissão de novas raízes.",
