...
export const maxillariaLeucaimata = {
    ...
    substrato: "🥇 Casca de pinus média + carvão vegetal + pedra-pomes ou brita fina.\n🥈 Casca média + carvão + pequena fração de esfagno solto em ambientes mais secos.\n🥉 Fibra de coco grossa bem lavada + carvão + pedra-pomes.\n⭐ Pode receber pequena fração de akadama, desde que a mistura permaneça estrutural. Mantenha o rizoma sobre a superfície e replante quando novas raízes iniciarem ou quando o material começar a compactar.",
