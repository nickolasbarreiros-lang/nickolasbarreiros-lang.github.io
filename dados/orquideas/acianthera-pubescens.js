...
export const aciantheraPubescens = {
    ...
    substrato: ["Montagem em nó de pinho, cortiça ou madeira com uma lâmina fina de esfagno apenas sob as raízes.", "Esfagno de fibra longa usado muito solto + pedra-pomes fina; evitar compactação junto ao rizoma.", "Casca de pinus fina + perlita + pedra-pomes fina + pequena fração de esfagno solto.", "Chips de coco pequenos + perlita + casca de pinus fina, mantendo o conjunto leve e aerado."],
