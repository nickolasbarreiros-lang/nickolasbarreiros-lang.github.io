...
export const howearaLavaBurst = {
    ...
    substrato: "🥇 Casca de pinus fina + pedra-pomes + carvão vegetal miúdo.\n🥈 Esfagno de fibra longa bem solto + pedra-pomes.\n🥉 Fibra de coco fina bem lavada + casca fina + carvão.\n🏅 Casca fina + pedra-pomes + pequena fração de akadama + carvão, sempre sem compactação.",
