...
export const arpophyllumGiganteum = {
    ...
    substrato: ["Casca de pinus média/grossa + pedra-pomes + carvão vegetal.", "Casca grossa + brita ou pedra-pomes + carvão vegetal.", "Mistura muito aberta com pequena fração retentora apenas quando a secagem local for rápida demais."],
