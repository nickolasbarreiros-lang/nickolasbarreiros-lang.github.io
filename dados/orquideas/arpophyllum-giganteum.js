export const arpophyllumGiganteum = {
    ...
    origem: "México ao noroeste da Venezuela e Jamaica.",
    regiao: "México, América Central, Jamaica, Colômbia e noroeste da Venezuela.",
    habitat: "Predominantemente epífita rizomatosa de florestas tropicais úmidas de montanha, aproximadamente entre 800 e 1.500 m, sob boa luminosidade filtrada, umidade elevada e ventilação constante.",
    descricao: "Orquídea de porte grande, formando touceiras robustas. Possui pseudobulbos cilíndricos e fortemente comprimidos, cada um sustentando uma folha coriácea em forma de fita. A inflorescência terminal, cilíndrica e densamente multiflora, pode atingir cerca de 40 cm e concentra numerosas flores pequenas rosa a púrpura em disposição espiralada.",
    caracteristicas: ["Epífita rizomatosa", "Porte grande", "800–1.500 m", "Inflorescência até ~40 cm", "Flores rosa-púrpura", "Touceira robusta"],
    fotos: [
