...
export const zygolumLouisendorf = {
    ...
    "caracteristicas": [
        ...
        "Pseudobulbos ovoides",
        "Folhas plissadas",
        "Flores verdes, castanhas e violetas",
        "Perfume intenso",
        "Raízes sensíveis à secagem",
        "Prefere clima intermediário a ameno"
    ],
    "fotos": [
    ...
    "substrato": "🥇 Casca média + pedra-pomes + carvão + 15–25% de esfagno solto.\n🥈 Casca fina + perlita + fibra de coco tratada.\n🥉 Esfagno solto + pedra-pomes em vaso baixo muito ventilado.\nO meio deve permanecer fresco, úmido e aerado.",
