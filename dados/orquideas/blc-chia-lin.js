...
export const blcChiaLin = {
    ...
    substrato: "🥇 Casca de pinus média/grossa + carvão vegetal + pedra-pomes.\n🥈 Carvão + brita ou pedra-pomes + casca grossa para máxima drenagem.\n🥉 Chips de coco bem lavados e dessalinizados + carvão + pedra-pomes em locais de secagem muito rápida.\nO vaso deve ser apenas proporcional ao sistema radicular e o substrato substituído antes de ficar ácido, fino ou compactado.",
