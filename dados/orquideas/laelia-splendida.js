...
export const laeliaSplendida = {
    ...
    substrato: [
        "🥇 Casca de pinus grossa + pedra-pomes + carvão vegetal.",
        "🥈 Pedra-pomes + carvão vegetal + casca grossa em menor proporção.",
        "🥉 Cultivo montado, com pouca ou nenhuma retenção junto às raízes."
    ],
    errosComuns: [
