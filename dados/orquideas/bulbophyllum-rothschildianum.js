...
export const bulbophyllumRothschildianum = {
    ...
    descricao: "Bulbophyllum rothschildianum (O'Brien) J.J.Sm. é uma espécie aceita de Bulbophyllum sect. Cirrhopetalum e uma das mais reconhecíveis do grupo. POWO registra distribuição de Darjeeling e Himalaia Oriental ao sul de Yunnan, incluindo Assam e norte de Myanmar, em bioma subtropical. A planta é epífita, de pequeno porte, com pseudobulbos ovoides unifoliados sobre rizoma rastejante. As inflorescências basais, eretas e umbeladas produzem poucas flores dispostas em leque. Segundo IOSPE, cada flor mede aproximadamente 2,5 cm de largura por até 17 cm no eixo formado pelas longas sépalas, e pode exalar perfume frutado lembrando pêssego. O epíteto homenageia a família Rothschild, conhecida pelo interesse em orquídeas. A espécie floresce principalmente na primavera e no outono e é descrita em cultivo como quente a fresca, o que deve ser interpretado como plasticidade térmica dentro de ambientes subtropicais úmidos, não como exigência de frio.",
    ...
    substrato: "🥇 Casca de pinus média + pedra-pomes + carvão + pequena quantidade de esfagno.\n🥈 Esfagno de fibra longa solto + pedra-pomes.\n🥉 Fibra de coco grossa tratada + pedra-pomes + carvão.\nO objetivo é retenção moderada com muita oxigenação.",
