...
export const laeliaPraestans = {
    ...
    substrato: "🥇 Casca de pinus média + carvão vegetal + pedra-pomes.\n🥈 Casca média + pedra-pomes + pequena quantidade de esfagno solto.\n🥉 Casca média/grossa + carvão + fibra de coco grossa em cachepô.\nEm montagem, uma camada fina de esfagno pode ajudar no estabelecimento sem manter as raízes permanentemente molhadas.",
