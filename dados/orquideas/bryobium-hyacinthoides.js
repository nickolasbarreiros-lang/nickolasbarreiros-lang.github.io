...
export const bryobiumHyacinthoides = {
    id: "bryobium-hyacinthoides",
    ...
    caracteristicas: [
        "Sinônimos Eria e Pinalia",
        "Touceira multifloral",
        "Flores pequenas",
        "Alta umidade",
        "Meia-sombra",
    ...
    descricao: "Uma orquídea asiática de floração delicada e abundante. Bryobium hyacinthoides forma pseudobulbos agrupados com folhas estreitas e produz hastes eretas cobertas por dezenas de pequenas flores, criando um conjunto muito mais vistoso do que o tamanho individual das flores sugere. Nativa de florestas úmidas do Sudeste Asiático, da Tailândia até a Malésia ocidental e meridional, cresce principalmente sobre árvores e pode ocorrer em diferentes altitudes. Gosta de umidade regular, mas suas raízes continuam sendo de uma epífita: precisam de bastante ar e não de substrato permanentemente encharcado. Em coleções, ainda pode ser encontrada pelo antigo nome Eria hyacinthoides.",
    origem: "Sudeste Asiático",
    regiao: "Tailândia à Malesia ocidental/sul",
    habitat: "Epífita/litófita · floresta úmida · 500–1.700 m",
    clima: "Quente–fresco · úmido · meia-sombra ventilada",
    climaFloracao: "A espécie responde melhor quando a touceira amadurece e acumula vários pseudobulbos. A época pode variar conforme procedência e cultivo; água regular, boa meia-sombra e raízes livres de salinização favorecem a produção de múltiplas hastes.",
    iluminacao: {
        sombrite: "60% a 70%",
    ...
    rega: "Mantenha o meio levemente úmido e bem oxigenado. Regue antes de ocorrer secagem prolongada, mas nunca deixe o recipiente saturado. Nos meses mais frios, reduza apenas conforme a evaporação cair.",
