...
export const cattleyaGuttataVarCoerulea = {
    ...
    substrato: "🥇 Casca de pinus grossa + carvão vegetal + pedra-pomes.\n🥈 Carvão + pedra-pomes ou brita + casca grossa.\n🥉 Casca grossa + argila expandida + carvão.\nEm recipientes grandes, use partículas maiores também no núcleo para evitar compactação e retenção prolongada ao longo dos anos.",
