...
// A progênie continua sendo Cattleya walkeriana; o cruzamento identifica os clones parentais albos.
...
export const cattleyaWalkerianaFAlbaGnomusXFAlbaSuprema = {
    ...
    fotos: [
        "imagens/cattleya-walkeriana-alba-gnomus-suprema/cattleya-walkeriana-alba-gnomus-suprema-1.webp",
        "imagens/cattleya-walkeriana-alba-gnomus-suprema/cattleya-walkeriana-alba-gnomus-suprema-2.jpg",
    ...
    iluminacao: {
        ...
        observacoes: "Necessita luz muito alta para formar pseudobulbos compactos e florescer. Em Serra/ES, prefira sol suave bem cedo e proteção contra a radiação forte do fim da manhã e da tarde. Folhas devem permanecer firmes, em verde médio a verde-claro, sem amarelecimento excessivo ou queimaduras."
    },
    ...
    adubacao: "🌿 Orgânica: bokashi apenas em quantidade mínima, preferencialmente em sachê e longe do rizoma, durante crescimento ativo.\n💧 Mineral/Foliar: NPK equilibrado, como 20-20-20 ou equivalente, em 1/4 a 1/3 da dose, semanal ou quinzenalmente enquanto houver brotação e enraizamento.\n🌱 Maturação: reduza o excesso de nitrogênio quando o pseudobulbo estiver completando o crescimento.\n🧪 Liberação lenta: geralmente desnecessária em plantas montadas; em vasos ou cachepôs, use apenas poucos grânulos.\n🚿 Lavagem: faça regas periódicas somente com água para evitar acúmulo de sais nas raízes expostas.",
    rega: "Durante emissão de brotos e raízes novas, regue abundantemente e permita secagem rápida entre as irrigações. Em planta montada no verão de Serra/ES, isso pode significar regas frequentes. Quando as raízes reduzirem a atividade e os pseudobulbos estiverem maduros, aumente gradualmente os intervalos. Não use a ponta verde como um interruptor absoluto: raízes fechadas não significam que a planta deva permanecer seca por semanas. Observe também turgor dos pseudobulbos, temperatura, umidade e velocidade de secagem do suporte.",
    suporte: "🥇 Placa de madeira dura ou cortiça — permite raízes livres, rápida secagem e leitura visual da atividade radicular.\n🥈 Cachepô ou cestinho pequeno de madeira — ótima aeração com alguma estabilidade hídrica.\n🥉 Vaso de barro raso e muito perfurado — opção segura para cultivo envasado.\n⭐ Pedra porosa ou placa mineral também pode funcionar, respeitando o hábito litófito da espécie.",
    substrato: "🥇 Sem substrato, montada diretamente em madeira ou cortiça.\n🥈 Casca de pinus grossa + carvão vegetal grosso + pedra-pomes.\n🥉 Brita grossa + carvão + pequena quantidade de casca grossa.\nEvite substrato fino, compactado e recipientes grandes. Em vaso mineral, impeça que a brita exposta aqueça excessivamente as raízes no verão.",
    ...
    adaptacaoRegional: {
        litoralQuente: "Boa adaptação em Serra/ES. O calor é tolerado; o maior risco é a combinação de chuva contínua, umidade persistente e pouca ventilação. Cultivo montado ou muito aerado é especialmente indicado.",
