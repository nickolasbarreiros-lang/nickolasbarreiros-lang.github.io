...
export const aciantheraGlumacea = {
    ...
    substrato: ["Casca de pinus fina/média + carvão + pequena quantidade de esfagno.", "Casca de pinus fina + pedra-pomes + pequena fração de fibra retentora.", "Cultivo montado com fina camada de esfagno solto sob as raízes."],
