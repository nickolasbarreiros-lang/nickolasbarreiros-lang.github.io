export const aciantheraGlumacea = {
    ...
    origem: "Brasil — principalmente regiões Sudeste e Sul.",
    regiao: "Mata Atlântica do Sudeste e Sul do Brasil.",
    habitat: "Epífita ou rupícola de florestas úmidas e serranas, sob luz filtrada, umidade atmosférica elevada e circulação contínua de ar.",
    descricao: "Espécie brasileira anteriormente conhecida como Pleurothallis glumacea. Forma touceiras cespitosas densas com ramicaules eretos e folhas coriáceas. Suas inflorescências racemosas lembram pequenas espigas e podem abrir em conjunto. As flores têm cerca de 1,9 cm e há registro de fragrância discreta.",
    caracteristicas: ["Touceira cespitosa", "Inflorescência em espiga", "Flores ~1,9 cm", "Perfume discreto", "Mata Atlântica", "Clima intermediário a fresco"],
    fotos: [
...
🧪 Liberação lenta: Osmocote 14-14-14 em dose baixa, apenas em cultivo envasado e sempre afastado das raízes e dos ramicaules. Após a maturação dos novos crescimentos, reduza a frequência da adubação.",
    ...
    errosComuns: ["Alterar bruscamente luz ou microclima durante a formação das hastes.", "Encharcar o centro de touceiras densas.", "Cultivar em calor abafado.", "Usar substrato decomposto ou compactado.", "Usar vaso excessivamente grande.", "Manter sombra profunda."],
    adaptacaoRegional: {
        litoral: "Cultivo possível, mas exige 60% a 70% de sombra, máxima ventilação e recipiente pequeno e aberto. O maior risco é calor noturno somado a umidade parada em touceiras densas.",
        montanha: "Adaptação muito boa. Noites amenas favorecem vigor e floração; em inverno úmido, espace as regas sem permitir desidratação prolongada."
    },
    dica: "Preserve a estabilidade quando as hastes aparecerem e mantenha o centro da touceira arejado. Evite mudanças bruscas de luz ou posição e impeça que água permaneça retida entre os ramicaules."
};