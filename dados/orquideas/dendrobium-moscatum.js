...
export const dendrobiumMoscatum = {
    ...
    "caracteristicas": [
        ...
        "Canas longas, robustas e arqueadas",
    ...
    "substrato": "Opção 1: casca grossa + carvão grosso + pedra-pomes.\nOpção 2: fibra de coco grossa + brita para estabilidade.\nOpção 3: casca média com pequena fração de esfagno em locais secos.\nAs raízes exigem muito ar e substrato estrutural. Misturas velhas e compactadas devem ser substituídas no início do novo enraizamento.",
    "errosComuns": "Instalar em local baixo; impedir o arco natural das canas; sombra excessiva; encharcar no inverno; cortar canas antigas; reduzir água antes da maturação; excesso de nitrogênio no final do verão; vaso leve; mudar constantemente de posição; substrato velho.",
    "dica": "Instale a planta em posição elevada enquanto ainda é jovem e observe o amadurecimento das canas. Só reduza regas quando elas pararem de alongar e endurecerem. Em Serra/ES, o calor não é o maior problema; o risco real é a chuva contínua no período de repouso moderado.",
    "adaptacaoRegional": {
