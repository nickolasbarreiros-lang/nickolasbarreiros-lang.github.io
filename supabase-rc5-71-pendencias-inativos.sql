-- Plenitude Ponto RC5.71
-- Fonte única de pendências, ignorando funcionários inativos.

begin;

create or replace function public.dashboard_pendencias_ativas_v3()
returns table(
  chave text,
  tipo_pendencia text,
  referencia_id uuid,
...
revoke all on function public.dashboard_pendencias_ativas_v3()
from public,anon;

grant execute on function public.dashboard_pendencias_ativas_v3()
to authenticated;
